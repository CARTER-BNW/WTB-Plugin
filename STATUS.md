...
- Released V6.4, V6.4.1, V6.4.2 (atomic claim tx - closes the 79k-item loss window found in the live-DB audit). Deploy WTB-6.4.2.jar to sky-mc.net: https://github.com/CARTER-BNW/WTB-Plugin/releases/tag/V6.4.2
